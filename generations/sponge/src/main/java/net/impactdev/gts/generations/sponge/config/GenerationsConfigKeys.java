package net.impactdev.gts.generations.sponge.config;
...
public class GenerationsConfigKeys implements ConfigKeyHolder {

    public static final ConfigKey<GenerationsPriceControls> PRICE_CONTROLS = customKey(adapter -> {
        GenerationsPriceControls controller = new GenerationsPriceControls();
    ...
    static {
        ...
        Field[] values = GenerationsConfigKeys.class.getFields();
        int i = 0;
